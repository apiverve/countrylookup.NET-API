...
namespace APIVerve
{
    public class CountryLookupAPIClient
    {
        ...
        public CountryLookupAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public CountryLookupAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(countrylookupQueryOptions options)
        {
            try
            {
                if (_isDebug)
